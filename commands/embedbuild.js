...
module.exports = {
    ...
    async execute(message,args, cmd, client, Discord){
        ...
        .setDescription('`<embedbuild/embd, title(one word), color(hex code or basic colors in caps; i.e(YELLOW), description(embed body)) example: <embd Test1, YELLOW, Test 2 and Test3`')
